    ...
    <transition name="slide-left">
      <div v-show="!showUnlockForm" class="size-full">
        ...
        <div class="flex h-full justify-center px-[10%]">
          <div
            class="bg-accent flex-center relative mr-20 mb-14 h-4/5 w-2/5 flex-auto rounded-3xl text-center text-[260px]"
          >
            <span class="absolute top-4 left-4 text-xl font-semibold">
              {{ meridiem }}
            </span>
            {{ hour }}
          </div>

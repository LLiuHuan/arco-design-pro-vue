...
<!--            &lt;!&ndash;            <p class="init_p">2.请您确认是否已经阅读过官方文档</p>&ndash;&gt;-->
<!--            <p class="init_p">2.请您确认是否了解后续的配置流程</p>-->
<!--            &lt;!&ndash;            <p class="init_p">注：开发组不为文档中书写过的内容提供无偿服务</p>&ndash;&gt;-->
<!--            <p class="init_btn">-->
<!--              &lt;!&ndash;              <a-button type="primary" @click="goDoc"> 阅读文档 </a-button>&ndash;&gt;-->
...
<!--                &lt;!&ndash;                <a-option key="pgsql" label="pgsql(测试版)" value="pgsql" />&ndash;&gt;-->
<!--              </a-select>-->
<!--            </a-form-item>-->

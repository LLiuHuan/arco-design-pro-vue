export default {
  ...
  login: {
    ...
    banner: {
      slogan1: 'Out-of-the-box high-quality template',
      subSlogan1:
        'Rich page templates, covering most typical business scenarios',
      slogan2: 'Built-in solutions to common problems',
      subSlogan2:
        'Internationalization, routing configuration, state management everything',
      slogan3: 'Access visualization enhancement tool AUX',
      subSlogan3: 'Realize flexible block development',
    },
    pwdLogin: {
      title: 'Login',

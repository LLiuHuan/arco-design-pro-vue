...
export function useRouterPush(inSetup = true) {
   ...
   */
  function toLogin(loginModule?: LoginModuleType, redirectUrl?: string) {
    const module: LoginModuleType = loginModule || 'pwd-login';
   ...
   */
  function toLoginModule(module: LoginModuleType) {

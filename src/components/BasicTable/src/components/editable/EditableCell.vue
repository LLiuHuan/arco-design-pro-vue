...
<!--      {{ getValues }}-->
<!--      <icon-edit class="edit-icon" v-if="!column.editRow" />-->
<!--      &lt;!&ndash;      <n-icon class="edit-icon" v-if="!column.editRow">&ndash;&gt;-->
<!--      &lt;!&ndash;        <FormOutlined />&ndash;&gt;-->
<!--      &lt;!&ndash;      </n-icon>&ndash;&gt;-->
<!--    </div>-->
...
<!--        <icon-check class="mx-2 cursor-pointer" @click="handleSubmit" />-->
<!--        <icon-close class="mx-2 cursor-pointer" @click="handleCancel" />-->
<!--        &lt;!&ndash;        <n-icon class="mx-2 cursor-pointer">&ndash;&gt;-->
<!--        &lt;!&ndash;          <CheckOutlined @click="handleSubmit" />&ndash;&gt;-->
<!--        &lt;!&ndash;        </n-icon>&ndash;&gt;-->
<!--        &lt;!&ndash;        <n-icon class="mx-2 cursor-pointer">&ndash;&gt;-->
<!--        &lt;!&ndash;          <CloseOutlined @click="handleCancel" />&ndash;&gt;-->
<!--        &lt;!&ndash;        </n-icon>&ndash;&gt;-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
...
<!--        let valueField = isCheckValue ? 'checked' : 'model-value';-->
